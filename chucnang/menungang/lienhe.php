    ...
    <div class="contact-container">
        ...
        <div class="contact-info">
            ...
            <ul>
                ...
                <li><i class="fa fa-envelope"></i> Contact@hp.vn</li>
                <li><i class="fa fa-map-marker"></i> S1.10 Vinhomes Ocean Park - Đa Tốn - Gia Lâm - Hà Nội</li>
                <li><i class="fa fa-clock-o"></i> Thứ 2 - CN : 8h00 - 24h00</li>
            </ul>
